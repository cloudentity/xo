...
```sh
$ go get -u github.com/cloudentity/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/cloudentity/xo
```
...
$ cp "$GOPATH/src/github.com/cloudentity/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/cloudentity/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/cloudentity/xo
```
