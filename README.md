...
```sh
$ go get -u github.com/mbilski/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/mbilski/xo
```
...
$ cp "$GOPATH/src/github.com/mbilski/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/mbilski/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/mbilski/xo
```
